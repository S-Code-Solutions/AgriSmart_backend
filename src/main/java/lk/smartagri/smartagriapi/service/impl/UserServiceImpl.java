...
import lk.smartagri.smartagriapi.dto.UserOTPDTO;
...
import lk.smartagri.smartagriapi.repository.UserOTPRepository;
    ...
    public String updateUser(UserDTO userDTO) {
        if (userRepository.existsByUsername(userDTO.getUsername())) {
            userRepository.updateUser(userDTO.getAddress(),userDTO.getEmail(),
                    ...
                    userDTO.getStatus(),userDTO.getRoleCode(),userDTO.getUsername());
            return VarListUtil.RSP_SUCCESS;
        } else {
            return VarListUtil.RSP_NO_DATA_FOUND;
        }
